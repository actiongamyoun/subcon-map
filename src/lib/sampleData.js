...
// 좌표는 부산권 실제 위치 부근으로 넣어 카카오 지도/경로가 자연스럽게 동작합니다.
...
export const SAMPLE = {
  ...
  partners: [
    {
      id: 'p1', name: '대한코팅', cat: 'paint',
      addr: '부산광역시 강서구 미음산단로', desc: '선체 외판 방식 도장 전문',
    ...
    {
      id: 'p2', name: '동양블라스팅', cat: 'surf',
      addr: '부산광역시 사하구 다대로', desc: '블록 표면 블라스팅·표면처리 외주',
    ...
    {
      id: 'p3', name: '정밀기계공업', cat: 'mech',
      addr: '경상남도 양산시 산막공단북5길', desc: '러더·샤프트 정밀 부품 가공 및 납품',
    ...
    {
      id: 'p4', name: '해성전기', cat: 'elec',
      addr: '부산광역시 사상구 학장로', desc: '선박 전장 설치 및 배선 시공',
    ...
    {
      id: 'p5', name: '남부정밀용접', cat: 'weld',
      addr: '울산광역시 울주군 온산읍', desc: '블록 정도관리 및 구조 용접',
  ...
  projects: [
    { id: 'prj1', name: '2031호선 (PCTC)', note: '자동차운반선', partnerIds: ['p1', 'p2', 'p4'] },
    { id: 'prj2', name: '2032호선 (LNG)', note: 'LNG운반선', partnerIds: ['p1', 'p3', 'p5'] },
  ],
}
